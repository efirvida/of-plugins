...
{{
    ...
    // The dictionary name IS the output directory: OpenFOAM's `probes` writes
    // to postProcessing/<name>/<startTime>/U and ignores a `name` entry, so
    // this key must stay in sync with compareNacelle.py's PROBE_GLOB.
    profiles
    {{
